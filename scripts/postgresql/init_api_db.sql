...
COPY products(title,description,base_cost,total_cost,discount,images,id_category,properties,sale_group)
    FROM '/products.csv'
    DELIMITER ','
    CSV HEADER;

INSERT INTO promo_codes(id, code, sale) VALUES (1, 'MINUS10', 10);
INSERT INTO promo_codes(id, code, sale) VALUES (2, 'MINUS20', 20);
INSERT INTO promo_codes(id, code, sale) VALUES (3, 'MINUS30', 30);
INSERT INTO promo_codes(id, code, sale) VALUES (4, 'MINUS40', 40);
--
